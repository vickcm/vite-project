<template>
  <div>
    ...
    <p class=" text-gray-500 mb-2">*Es posible que la visualización de la tabla en dispositivos pequeños se vea
      ...
      <table class="min-w-full divide-y divide-gray-200 mt-4">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          <tr v-for="product in products" :key="product.id">
            <td class="px-4 py-2 whitespace-nowrap ">{{ product.titulo }}</td>
            <td class="px-4 py-2 whitespace-nowrap ">$ {{ product.precio }}</td>
